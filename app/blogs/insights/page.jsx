  ...
  function sufianmustafawebdeveloperblogs() {
    return {
      __html: `  {
        ...
        "url": "https://sufianmustafa.com/blogs/insights",
        "author": {
          "@type": "Person",
          "name": "Sufian Mustafa"
        },
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://sufianmustafa.com/blogs/insights"
        }
      }
  `,
    };
  ...
  return (
    <div style={{ minHeight: "100vh" }} suppressHydrationWarning>
      ...
      JavaScript with a particular focus on ReactJS NextJS"
        ...
        <meta
          property="og:url"
          content="https://sufianmustafa.com/blogs/insights"
        />
        <link rel="canonical" href="https://sufianmustafa.com/blogs/insights" />
        <NextSeo
          title="Blogs - Sufian Mustafa"
          description="Explore Sufian Mustafa's blog for insightful articles and updates on web development, technology, and more."
          author="Sufian Mustafa"
          canonical="https://sufianmustafa.com/blogs/insights"
          openGraph={{
            title: "Blogs - Sufian Mustafa",
            description:

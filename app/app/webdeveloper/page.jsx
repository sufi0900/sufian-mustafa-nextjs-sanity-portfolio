...
export const metadata = {
  ...
  description:
    "Welcome to the portfolio of SuFiaN MusTaFa, a passionate web developer based in Pakistan. Explore my portfolio showcasing expertise in ReactJs, Nextjs, HTML5, CSS, JavaScript, and more. Download my resume or portfolio and get in touch for your web development needs. My nick name is sufi. sufian website",
  ...
  function sufianmustafa() {
    return {
      __html: `    {
        ...
        "url": "https://sufianmustafa.com/webdeveloper",
        "sameAs": [
          "https://dev.to/sufian",
        ],
        "image": [
  ...
  return (
    <>
      ...
      JavaScript with a particular focus on ReactJS NextJS"
        ...
        <meta
          property="og:url"
          content="https://sufianmustafa.com/webdeveloper/"
        />
        ...
        <link rel="canonical" href="https://sufianmustafa.com/webdeveloper/" />
        <NextSeo
          title="Sufian Mustafa - Website"
